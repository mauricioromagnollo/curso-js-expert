...
// Ou seja, no fim tudo herda de Object e tudo herda de null
...
// console.log('Manager.prototype.salary() -> ', Manager.salary()) // Erro

// Se não chamar o 'new', o primeiro __proto__ vai ser sempre a instância de Function, sem herdar nossas classes
...
console.log(manager.__proto__) // { monthlyBonuses: [Function (anonymous)] }
console.log(manager.__proto__.__proto__) // { profitShare: [Function (anonymous)] }
